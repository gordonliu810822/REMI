...
#' REMI
#' @description
#' Fit REMI-R using summary statistics from GWAS.
#'
...
#' @examples
#‘ REMI_R(summarystat_file,plink_file);
#' @details
#' \code{REMI_R} fits the REMI-R with summary statistics from GWAS. It requires to provide the reference panel data for SNPs in PLINK bfile format. The summary statistics in file \code{stringname1} and the reference panel is in file \code{stringname2}.
#' @export

REMI_R <-  function(stringname1, stringname2, nstep = 100, epsilon = 0.05, bandwidth = 200,
   shrinkagefactor = 0.9){
